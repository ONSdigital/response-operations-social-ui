...
from response_operations_social_ui.views.social.social_case_search import format_address_for_results
...
class TestSocialCaseSearch(ViewTestCase):
    ...
    def test_valid_postcode(self, mock_request):
        ...
        response = self.client.get(f'/?query={quote_plus(postcode)}')
