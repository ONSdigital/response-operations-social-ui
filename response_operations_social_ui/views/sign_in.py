...
from response_operations_social_ui.common import token_decoder
from response_operations_social_ui.controllers import uaa_controller
from response_operations_social_ui.forms import LoginForm
...
def sign_in():
    ...
    if current_user.is_authenticated:
        return redirect(url_for('social_bp.social_case_search'))
